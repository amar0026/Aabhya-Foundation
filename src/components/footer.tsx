...
const SERVICES_LINKS = [
  ...
  { label: "Food & Nutrition", to: "/Funding" },
  { label: "Education Programs", to: "/Funding" },
  {label: "Women Empowerment", to: "/Funding"},
  { label: "Medical Aid", to: "/Funding" },
  { label: "Donate Blood", to: "/Donation" },
  { label: "Volunteer Training", to: "/VolunteerPage" },
];
          ...
          <div className="flex flex-col gap-6">
            ...
            <div className="flex flex-col gap-3 pt-2">
              ...
              <div className="flex items-center bg-white rounded-lg overflow-hidden border border-gray-200">
                ...
                />
                <button className="bg-[#E8522A] hover:bg-[#cf4521] text-white font-bold
