        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
          {visible.map((t, idx) => (
            <div
              ...
              style={{
                animation: `ts-fade-up 0.45s ${idx * 0.09}s cubic-bezier(0.22,1,0.36,1) both`,
            ...
            >
              ...
              <div className="flex items-start justify-between gap-4">
                <div className="flex items-center gap-4">
                  <div
                    className="w-16 h-16 rounded-full overflow-hidden shrink-0 border-2 border-gray-100"
                    style={{
                      animation: `ts-img-pop 0.4s ${idx * 0.1 + 0.1}s cubic-bezier(0.34,1.56,0.64,1) both`,
                    }}
                  >
                  ...
                  <div>
                    ...
                    <p className="text-sm text-[#e8490f] font-medium mt-0.5">{t.role}</p>
                  </div>
                </div>
              ...
              <p
                ...
                style={{ animation: `ts-fade-in 0.5s ${idx * 0.1 + 0.2}s ease both` }}
              >
                "{t.quote}"
              </p>
